...
processes[process_id - 1] = false;System.out.println("Process " + process_id + " is down.");
}
}
...
while(true) {System.out.println("Bully Algorithm");
...
break;
case 4:System.out.print("Enter the process number to down:- ");
process_id = sc.nextInt();
