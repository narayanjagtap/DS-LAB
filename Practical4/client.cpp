...
/* OUTPUT
amol@amol-Aspire-5742:~$ g++ client.cpp
amol@amol-Aspire-5742:~$ ./a.out
Client starts. Client pid is 14122 
...
Client: read: 'From server, your clock adjustment offset is add 1.000000'
Client: received local clock adjustment offset (string) is add 1.000000
Client: received local clock adjustment offset (float) is add 1
Client local clock is 3.000000 
