...
/*OUTPUT
amol@amol-Aspire-5742:~$ g++ server.cpp
amol@amol-Aspire-5742:~$ ./a.out
Sever starts. Server pid is 14070 
...
You have connected 1 client(s) now.Server: new client accepted. client ip and port: 127.0.0.1:36458
...
Server: sent to client(127.0.0.1:36458): 'Hello from server, please tell me your local clock value.'
Server: recv from client(127.0.0.1:36458): 'Hello from client, my local clock value is 2.000000' 
Server: received client local clock (string) is 2.000000
Server: received client local clock (float) is 2


Server: sent to client(127.0.0.1:36458): 'From server, your clock adjustment offset is add 1.000000'


Server new local clock is 3.000000 
