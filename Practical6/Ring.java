...
int coordinator;
boolean processes[];
ArrayList<Integer> pid;public Ring(int max) {
coordinator = max;
max_processes = max;
...
void upProcess(int process_id) {if(!processes[process_id-1]) {
...
Ring ring = null;int max_processes = 0, process_id = 0;
int choice = 0;
...
break;
case 3:System.out.print("Enter the process to up:- ");
